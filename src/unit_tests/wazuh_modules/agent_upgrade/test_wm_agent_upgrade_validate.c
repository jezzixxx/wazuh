...
void test_wm_agent_upgrade_validate_system_msvsphere_ok(void **state)
{
    (void) state;
    char *platform = "msvsphere";
    char *os_major = "9";
    char *os_minor = "6";
    char *arch = "x64";
    char *package_type = NULL;
...
int main(void) {
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_wm_agent_upgrade_validate_system_msvsphere_ok),
